...
public class Principal {
	...
	public static void main(String[] args) {
		...
		ticketek.venderEntrada("El Rey León", "31/08/25", "alcides@violeta.com", "1234", "Platea Común", asientos);
		List<IEntrada> entradasConejo = ticketek.venderEntrada("El Rey León", "29/07/25",
		...
		System.out.println("Precio de funcion para El Rey Leon (VIP): $"
				+ ticketek.costoEntrada("El Rey León", "29/07/25", "Platea VIP"));
		System.out.println("Precio de funcion para El Rey Leon (Común): $"
				+ ticketek.costoEntrada("El Rey León", "29/07/25", "Platea Común"));

		System.out.println("\nPrecio de entrada para Coldplay: $" + entradasAlcides.getFirst().precio());
		System.out
				.println("Precio de funcion para Coldplay: $" + ticketek.costoEntrada("Coldplay en vivo", "31/07/25"));
