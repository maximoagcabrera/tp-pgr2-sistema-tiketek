...
public interface ITicketek {
	...
	/**
	 * 1) Registra las sedes que no tienen asientos, como los estadios. Estas tienen
	 * un unico sector llamado campo.
	 * 
	 * Si el nombre ya está registrado, se debe lanzar una excepcion. Si algun dato
	 * no es aceptable, se debe lanzar una excepcion.
	 * 
	 * @param nombre
	 * @param direccion
	...
	/**
	 * 1) Registra las sedes con asientos y sin puestos de venta, teatros. Estos
	 * reciben la informacion de los sectores como parámetros.
	 * 
	 * Si el nombre ya está registrado, se debe lanzar una excepcion. Si algun dato
	 * no es aceptable, se debe lanzar una excepcion.
	 * 
	...
	/**
	 * 1) Registra las sedes con asientos y puestos de venta, miniestadios. Estos
	 * reciben la informacion de los sectores como parámetros. tambien el adicional
	 * por consumición y tambien la cantidad de puestos.
	 * 
	 * Si el nombre ya está registrado, se debe lanzar una excepcion. Si algun dato
	 * no es aceptable, se debe lanzar una excepcion.
	 * 
	 ...
	 * @param porcentajeAdicional
	 */
	void registrarSede(String nombre, String direccion, int capacidadMaxima, int asientosPorFila, int cantidadPuestos,
			double precioConsumicion, String[] sectores, int[] capacidad, int[] porcentajeAdicional);

	/**
	 * 2) Registrar un nuevo usuario en el sistema
	 * 
	 * Si el email ya está registrado, se debe lanzar una excepcion Si algun dato no
	 * es aceptable, se debe lanzar una excepcion.
	 * 
	 * @param email
	 * @param nombre
	 * @param apellido
	 ...
	 * 
	 * Si el nombre del espectáculo ya está registrado, lanza una excepcion.
	 * 
	 * @param nombre
	 */
	 ...
	 * @return
	 */
	List<IEntrada> venderEntrada(String nombreEspectaculo, String fecha, String email, String contrasenia,
			int cantidadEntradas);

	/**
	 * 4) Vende una o varias entradas a un usuario para funciones con sedes
	 * numeradas.
	 * 
	 * Devuelve una lista con las entradas vendidas (Ver interfaz IEntrada).
	 * 
	 * Se debe lanzar una excepcion si: - Si la sede de la funcion no es numerada -
	 * si el usuario no está registrado - si el espectaculo no está registrado - si
	 * la contraseña no es valida - etc...
	 * 
	 * @param nombreEspectaculo
	...
	/**
	 * 6) Devuelve una lista con todas las entradas que compró un usuario y aún no
	 * se han usado (según la fecha de la entrada) Se debe autenticar al usuario.
	 * 
	 * Si el usuario no está registrado o la contraseña no es valida, se lanza una
	 * excepcion
	 * 
	 * Ver interfaz IEntrada.
	 * 
	...
	/**
	 * 9) Si puede asignar la entrada en la nueva fecha, anula la entrada anterior.
	 * Devuelve una entrada nueva (Ver interfaz IEntrada).
	 * 
	 * Lanza excepcion si: - Si la entrada original está en el pasado. - Si la
	 * contraseña no es valida. - etc...
	 * 
	 * 
	 * @param Entrada
	 * @param contrasenia
	...
	/**
	 * 9) Si puede asignar la ebtrada en la nueva fecha, anula la entrada anterior.
	 * Devuelve una entrada nueva (Ver interfaz IEntrada).
	 * 
	 * Lanza excepcion si: - la entrada original está en el pasado - Si la
	 * contraseña no es valida. - etc...
	 * 
	 * 
	 * @param Entrada
	...
	/**
	 * 11) devuelve el precio de la entrada para una funcion de un espectaculo en
	 * estadio.
	 * 
	 * @param nombreEspectaculo
	 * @param fecha             en formato: dd/mm/YY
	...
	/**
	 * 11) devuelve el precio de una entrada para una funcion de un espectaculo en
	 * una sede con asientos.
	 * 
	 * @param nombreEspectaculo
	 * @param fecha             en formato: dd/mm/YY
	 * @param sector
	...
	/**
	 * 13) Devuelve el total recaudado por una sede para un espectaculo en
	 * particular.
	 * 
	 * @param nombreEspectaculo
	 * @param nombreSede
